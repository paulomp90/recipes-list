...
<div class="mx-auto flex w-full max-w-screen-xl flex-col items-center py-24 md:flex-row">
    ...
    >
        ...
        <p class="mb-8 leading-relaxed">
            Dive into the world of exquisite flavors and culinary creativity with RecipeRealm, your
            ultimate companion for all things food. Whether you're a seasoned chef or a kitchen
            newbie, this app is your gateway to a universe of mouthwatering recipes, cooking tips,

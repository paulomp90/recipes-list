...
<div class="body-font text-gray-600">
    <div class="container mx-auto px-5 py-24">
        <h1 class="title-font mb-20 text-center text-2xl font-medium text-gray-900 sm:text-3xl">
        ...
        <div class="-mx-4 -mb-10 -mt-4 flex flex-wrap space-y-6 sm:-m-4 md:space-y-0">
            <div class="flex p-4 md:w-1/3">
                <div
                    class="mb-4 inline-flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-indigo-100 text-indigo-500"
                >
                    <svg
                        fill="none"
                        stroke="currentColor"
            ...
            <div class="flex p-4 md:w-1/3">
                ...
                <div class="flex-grow pl-6">
                    <h2 class="title-font mb-2 text-lg font-medium text-gray-900">Neptune</h2>
                    <p class="text-base leading-relaxed">
                        Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy.
                        Gastropub indxgo juice poutine, ramps microdosing banh mi pug VHS try-hard
                        ugh iceland kickstarter tumblr live-edge tilde.
